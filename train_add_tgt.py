...
if __name__ == '__main__':
    ...
    if not args.no_init_train:
        for _ in range(args.threads):
            ...
            latent_tgt  = torch.cat([z.view(args.batch_size, args.chunk_size, latent_size), datas_tgts.view(args.batch_size, args.chunk_size, 1)], dim=-1)
            latent_tgt2 = torch.cat([z2.view(args.batch_size, 1, latent_size), next_datas_tgts.view(args.batch_size, 1, 1)], dim=-1)
